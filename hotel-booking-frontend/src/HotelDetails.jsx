...
const RoomDetail = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5001/hotel/${roomID}`)
      .then((response) => {
  ...
  return (
    <div className="body">
      ...
      <div>
        ...
        {room ? (
          <div
            style={{ width: "70vw", margin: "20px auto", textAlign: "left" }}
          >
            <div style={{ marginTop: "10px" }}>
              <p style={{ fontSize: "48px", fontWeight: "bolder" }}>
                {room.title}
              </p>
            ...
            <div>
              ...
              >
                Place to stay hosted by Our Hotel{" "}
              </h4>
              <br />
              ...
              <div className="column">
                <h6 style={{ fontWeight: "bold", fontSize: "18px" }}>
                  {" "}
                  <img
                    src={require("./assets/cancellationicon.png")}
                    alt="cancellationicon"
                    style={{ height: "40px" }}
                  />{" "}
                  Free cancellation before 2 days of check-in
                </h6>
                <p>{room.unique}</p>
                <hr></hr>
                <h6 style={{ fontWeight: "bold", fontSize: "18px" }}>
              ...
              <div>
                <h6 style={{ fontWeight: "bold", fontSize: "18px" }}>
                  Contact Number:{room.sellerphonenumber}
                </h6>
              </div>
            </div>
          </div>
          ...
          <p
            ...
            style={{ marginTop: "35vh", marginLeft: "60vw", scale: "2" }}
          >
