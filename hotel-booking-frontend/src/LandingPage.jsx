...
function LandingPage() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5001/landingpagerooms")
      .then((response) => {
    ...
    <div className="landing-page">
      <div className="section">
        <div id="section1topnavbar">
          <nav
            id="section1topnavbar"
            className="navbar navbar-expand-lg navbar-light bg-light bg-white px-lg-3 py-lg-2shadow-sm sticky top "
          >
            <div className="container-fluid">
              <a
                className="navbar-brand me-5 fw-bold fs-3 h-font"
                href="index.html"
              >
                HOTEL
              </a>
              ...
              >
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li className="nav-item">
                    <a className="nav-link me-2" href="/allHotels">
                      Room
                    </a>
                  </li>
                  <li className="nav-item">
                    <a
                      ...
                      onClick={scrollToAmenitiesSection}
                    >
                      Facilities
                    </a>
                  </li>
        ...
        <div id="firstcon">
          <div>
            ...
            <img
              ...
              src={require("./assets/houseimglanding.png")}
              alt="image"
            />
          </div>
        </div>
      ...
      <div>
        <div
          id="rownavbarcontainer"
          className="row"
          style={{ position: "relative", width: "30vw", marginLeft: "35vw" }}
        >
      ...
      <div>
        <div style={{ position: "relative" }}>
          ...
          >
            ...
            <div id="cardcon" class="col-lg-3 col-md-6 ny-3"></div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="features mb-4">
                      ...
                      {room.amenities.map((amenity, index) => (
                        <span
                          key={index}
                          className="badge rounded-pill bg-light text-dark text-wrap"
                        >
                          {amenity}
                        </span>
                      ))}
                    ...
                    <div className="d-flex justify-content-evenly mb-2">
                      <a
                        className="btn btn-sm text-white custom-bg shadow-none"
                        disabled
                      >
                        Book Now
                      </a>
                      <a
                        href={`/hotel/${room.RoomID}`}
        ...
        >
          <div style={{ display: "flex" }}>
            ...
            <div
              id="hotelamenties"
              style={{ flex: 1, textAlign: "start", padding: "20px" }}
            >
              <h2>Get Details About The Hotel</h2>
              <br></br>
              <img
                src={require("./assets/amenitiesicons.png")}
                alt=""
